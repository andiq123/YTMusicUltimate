...
- (UITableViewCell *)tableView:(UITableView *)tableView
  ...
  NSMutableDictionary *YTMUltimateDict = [NSMutableDictionary
  ...
  if (indexPath.section == 0) {
    ...
    NSArray *settingsData = @[
      @{
        @"title" : LOC(@"NO_ADS"),
        @"desc" : LOC(@"NO_ADS_DESC"),
        @"key" : @"noAds"
      },
      @{
        @"title" : LOC(@"BACKGROUND_PLAYBACK"),
        @"desc" : LOC(@"BACKGROUND_PLAYBACK_DESC"),
        @"key" : @"backgroundPlayback"
      },
      @{
        @"title" : LOC(@"BYPASS_REGION"),
        @"desc" : LOC(@"BYPASS_REGION_DESC"),
        @"key" : @"bypassRegion"
      }
    ];
    ...
    switchControl.onTintColor = [UIColor colorWithRed:30.0 / 255.0
                                                green:150.0 / 255.0
                                                 blue:245.0 / 255.0
                                                alpha:1.0];
...
- (void)toggleSwitch:(UISwitch *)sender {
  ...
  NSMutableDictionary *YTMUltimateDict = [NSMutableDictionary
      dictionaryWithDictionary:[defaults dictionaryForKey:@"YTMUltimate"]];
